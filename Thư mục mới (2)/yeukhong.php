...
<title>[Tên bạn] Gửi Tặng Cho Cá<3</title>
<link rel="shortcut icon" href="http://kênhit.vn/favicon.ico" type="rajnlove">
<link rel="icon" href="http://kênhit.vn/favicon.ico" type="rajnlove">
<meta name="description" content="Gửi Tặng Cho kênhit.vn">
...
<table width="100%"><tbody><tr><td width="7%"><td align=center>
	...
	<script language="JavaScript">
		...
		function al() {
		alert("Cảm ơn Cá nhiều lém!!");
		alert("Đã làm cho trái tim tớ hết đơn coi và lạnh giá");
		alert("Nắm tay tớ nha, mãi mãi của nhau hoy vì tớ iu cậu nhìu lém. Chỉ qua mạng thôi nhưng tình yêu đến là thật");
		alert("Đi nào....  !!!!");
		}
	</script>
<ul id="scroll">
...
<p id="copy" onClick="window.open('http://kênhit.vn','')">© 2022 By Yu
</p>
<script>
var txt="[Khuong] gửi tặng [everyone] ";
var espera=100;
var refresco=null;
